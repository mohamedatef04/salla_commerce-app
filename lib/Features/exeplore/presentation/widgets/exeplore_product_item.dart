...
class ExeploreProductItem extends StatefulWidget {
  const ExeploreProductItem({super.key, required this.productModel});
  final ProductModel productModel;

  @override
  State<ExeploreProductItem> createState() => _CategoryItemState();
}

class _CategoryItemState extends State<ExeploreProductItem> {
