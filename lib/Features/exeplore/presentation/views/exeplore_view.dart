...
import 'package:salla_commerce_app/Features/exeplore/presentation/widgets/exeplore_view_body.dart';
...
class ExeploreView extends StatelessWidget {
  const ExeploreView({super.key});
  static const routeName = '/exeplore-view';
    ...
    return BlocConsumer<CartCubit, CartState>(
      ...
      builder: (context, state) {
        return BlocConsumer<FavouriteCubit, FavouriteState>(
          ...
          builder: (context, state) {
            return const Scaffold(body: ExeploreViewBody());
          },
        );
      },
    );
